...
internal fun NicknameScreen(
    ...
    ZSScreen(
        ...
        CommonTitleView(
            titleRes = com.zerosome.design.R.string.screen_nickname_title,
            descriptionRes = com.zerosome.design.R.string.screen_nickname_description
        )
        ...
        ZSTextField(
            ...
            placeHolderText = stringResource(
                id = com.zerosome.design.R.string.screen_nickname_textfield_hint
            ),
